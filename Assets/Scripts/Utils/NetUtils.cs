...
public class NetUtils
{
    ...
    {
        //Debug.Log("Get MAC Begin");
        if (!IsHostAccessible(ipaddress.ToString()))
        {
            //Debug.Log("IsHostAccessible == false");
            return null;
        }
        else
        {
            //Debug.Log("IsHostAccessible == true");
        }
...
#pragma warning restore CS0618 // 형식 또는 멤버는 사용되지 않습니다.
        {
            //Debug.Log("SendARP((int)hostEntry.AddressList[0].Address, 0, macAddr, ref macAddrLen) != 0");
            return null;
        }
        else
        {
            //Debug.Log("SendARP Success");
        }
        ...
        Debug.Log("MAC : " + macAddressString.ToString());
